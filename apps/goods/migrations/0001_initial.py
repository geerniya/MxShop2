# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-11 16:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_brief', models.TextField(verbose_name='商品简要描述')),
                ('goods_desc', DjangoUeditor.models.UEditorField(default='', verbose_name='内容')),
                ('ship_free', models.BooleanField(default=True, verbose_name='是否承担运费')),
                ('goods_front_image', models.ImageField(blank=True, max_length=200, null=True, upload_to='goods/images/', verbose_name='商品图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_tag', models.BooleanField(default=False, help_text='是否导航', verbose_name='是否导航')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, help_text='父类别', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父目类别')),
            ],
            options={
                'verbose_name': '商品类别',
