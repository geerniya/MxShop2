...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey('self', null=True, blank=True, verbose_name='父目类别',
                                        help_text='父类别', related_name='sub_cat')
    is_tag = models.BooleanField(default=False, verbose_name='是否导航', help_text='是否导航')
...
class GoodsCategoryBrand(models.Model):
    ...
    image = models.ImageField(max_length=200, upload_to='brands/', verbose_name='商标图片')
    add_time = models.DateTimeField(auto_now_add=True, verbose_name='添加时间')
...
class Goods(models.Model):
    ...
    name = models.CharField(default='', max_length=300, verbose_name='商品名')
    goods_sn = models.CharField(default='', max_length=50, verbose_name='商品唯一货号')
    click_num = models.IntegerField(default=0, verbose_name='点击量')
    sold_num = models.IntegerField(default=0, verbose_name='售出数')
    fav_num = models.IntegerField(default=0, verbose_name='收藏数')
    goods_num = models.IntegerField(default=0, verbose_name='库存')
    market_price = models.FloatField(default=0, verbose_name='市场价格')
    shop_price = models.FloatField(default=0, verbose_name='本店价格')
    goods_brief = models.TextField(null=True, blank=True, verbose_name='商品简要描述')
    goods_desc = UEditorField(verbose_name='内容', imagePath='goods/images/', width=1000, height=300,
                              filePath='goods/files/', default='')
    ship_free = models.BooleanField(default=True, verbose_name='是否承担运费')
    goods_front_image = models.ImageField(max_length=200, upload_to='goods/images/', blank=True, null=True,
                                          verbose_name='商品图')
